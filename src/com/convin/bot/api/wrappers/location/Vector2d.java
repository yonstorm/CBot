...
import com.convin.bot.api.math.FastMath;
...
public class Vector2d implements Externalizable, Cloneable {
    ...
    /**
     * Creates a Vector2d with x and y set to 0. Equivalent to Vector2d(0,0).
     */
    public Vector2d() {
        x = y = 0;
    }
     ...
     * @return this
     */
    public Vector2d addLocal(float addX, float addY) {
        x += addX;
        y += addY;
        return this;
    }
     ...
     */
    public void interpolate(Vector2d finalVec, float changeAmnt) {
     ...
     */
    public void interpolate(Vector2d beginVec, Vector2d finalVec,
                            float changeAmnt) {
     ...
     * @return this
     */
    public Vector2d multLocal(float scalar) {
        x *= scalar;
        y *= scalar;
        return this;
    }
    ...
    /**
     * Multiplies this Vector2d's x and y by the scalar and stores the result in
     ...
     */
    public Vector2d mult(float scalar, Vector2d product) {
        if (null == product) {
     ...
     * @return this
     */
    public Vector2d divideLocal(float scalar) {
        x /= scalar;
        y /= scalar;
        return this;
    }
     ...
     * @return this
     */
    public Vector2d subtract(float valX, float valY) {
     ...
     * @return this
     */
    public Vector2d subtractLocal(float valX, float valY) {
        x -= valX;
        y -= valY;
        return this;
    }
     ...
     */
    public float smallestAngleBetween(Vector2d otherVector) {
     ...
     * @return the angle in radians.
     */
    public float angleBetween(Vector2d otherVector) {
     ...
     * this Vector2d as expressed by a conversion from rectangular coordinates (<code>x</code>,&nbsp;<code>y</code>)
    ...
    /**
     * Saves this Vector2d into the given float[] object.
     *
     * @param floats The float[] to take this Vector2d. If null, a new float[2] is
     *               created.
     ...
     * Vector2d.class.getName() or getClass().getName().
     * </p>
     *
    ...
    public Class<? extends Vector2d> getClassTag() {
    ...
    public Vector2d randomize(float maxOffset) {
        if (maxOffset == 0) return this;
        x += Calculations.getRandomNumberF(-maxOffset, maxOffset);
        y += Calculations.getRandomNumberF(-maxOffset, maxOffset);
        return this;
    }
}
